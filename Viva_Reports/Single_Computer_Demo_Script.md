# 🚀 Sentinel Home Hub: Single-Computer Demo Script

This guide contains every terminal command you will need during the live Viva presentation, assuming you are running the entire broker, dashboard, and CLI clients locally on your own laptop.

> [!TIP]
> **Pro-Tip:** Open your terminal and split it into multiple panes or tabs before the presentation starts so you aren't scrambling to open windows!

---

## Phase 1: Booting the Core Infrastructure

Start these first before showing anything to the evaluator.
...
Open new terminal tabs to show the custom CLI working perfectly alongside the web dashboard.
...
```
*This will blast 20 messages simultaneously over a single TCP socket. Watch the Web Dashboard Priority Queue carefully—you will see the red Fire Alarms instantly jump ahead of the green Battery updates!*
